...
mv $(workspaces.source.path)/source/*.sh $(workspaces.source.path)`, orasOptions, PreBuildImageDigest),
			},
			{
...
mv $(workspaces.source.path)/source/*.sh $(workspaces.source.path)
...
cp $(workspaces.source.path)/*.sh $(workspaces.source.path)/source-archive
